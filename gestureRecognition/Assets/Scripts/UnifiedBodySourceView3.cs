...
public class UnifiedBodySourceView3 : MonoBehaviour 
{
	GestureManagerComponent gestureManagerComponet;
    ...
    void Start()
    {
		...
		gestureManagerComponet = gameObject.GetComponent<GestureManagerComponent> ();
    }
    ...
    {
		gestureManagerComponet.Run (bodyObject);
